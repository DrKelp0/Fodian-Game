...
class Npcc(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.rect = self.image.get_rect()
        # Define the initial location
        self.rect.x, self.rect.y = (330, -2275)
...
def main():
    ...
    # Add the Npc to their own groups
    npc_sprites.add(npc)
    ...
    while not done:
        ...
        if time.time() - time_start < time_cooldown:
            ...
            for npc in npc_collided:
                ...
                elif numb_collided == 4 and numbc_collided == 0:
                    print("Back again?\n"
        ...
        if time.time() - time_start < time_cooldown:
            ...
            for npcc in npcc_collided:
                if numbc_collided == 0:
                    print("Wow!\n"
                          "Great job making it to the top.\n"
                          "Stay here for a while, you earned it.")
                    numbc_collided += 1
                    time_cooldown += 3
